...
const categories = [
  {
    ...
    title: 'PDV + Estoque',
    description:
      'Venda produto e serviço no mesmo caixa com baixa automática no estoque.',
  },
  {
    icon: Scissors,
    title: 'Agenda de banho e tosa',
    description:
      'Agendamentos, confirmação por WhatsApp e controle de profissionais em tempo real.',
  },
  {
    icon: Stethoscope,
    title: 'Prontuário e vacinas',
    description:
      'Histórico do pet, alertas de retorno e campanhas para vacinação recorrente.',
  },
  {
    icon: HeartHandshake,
    title: 'CRM e fidelização',
    description:
      'Programa de pontos, lembretes automáticos e ofertas segmentadas por perfil.',
  },
]
...
const topPlans = [
  {
    name: 'Essencial',
    description:
      'Para começar com agenda, PDV e gestão de clientes em uma unidade.',
    price: 'R$ 149/mês',
  ...
  },
  {
    name: 'Profissional',
    description:
      'Mais automações, relatórios avançados e apoio para ganhar escala com controle.',
    price: 'R$ 249/mês',
  ...
  },
  {
    name: 'Empresarial',
    description:
      'Multiunidades, gestão de equipe e suporte prioritário para alto volume.',
    price: 'R$ 399/mês',
...
const trustItems = [
  {
    ...
    description:
      'Onboarding prático para sua equipe operar rápido, sem travar a rotina.',
  },
  {
    icon: ShieldCheck,
    title: 'Dados seguros',
    description:
      'Backups automáticos, controle de acesso por perfil e infraestrutura monitorada.',
  },
  {
    icon: Sparkles,
    title: 'Suporte humano',
    description:
      'Atendimento no WhatsApp com especialistas em operação de pet shops.',
  },
]
      ...
      <div className='mx-auto max-w-7xl rounded-[34px] border border-white/80 bg-[#fffdfa] p-4 shadow-[0_28px_90px_-60px_rgba(52,42,35,0.65)] sm:p-8'>
        <header className='mb-8 flex flex-wrap items-center justify-between gap-4'>
          <Link to='/' className='flex items-center gap-3'>
            ...
            <div>
              <p className="text-sm font-semibold leading-none [font-family:'Sora',ui-sans-serif,system-ui]">
                FourPet Pro
              </p>
              <p className='text-xs text-slate-500'>
                Gestão inteligente para negócios de quatro patas.
              </p>
            </div>
          </Link>
          ...
          <div className='flex items-center gap-2'>
            ...
            <Link to='/login'>
              <Button
                variant='outline'
                className='rounded-full border-[#ebddd5] bg-white text-slate-700'
              >
                Entrar
              </Button>
            </Link>
            <Link to='/register'>
              <Button className='rounded-full bg-[#ffbf66] text-slate-900 hover:bg-[#ffb64e]'>
                Criar conta
              </Button>
            </Link>
          </div>
        ...
        <section className='grid gap-12 pb-14 lg:grid-cols-[1.02fr_0.98fr] lg:items-center'>
          <div className='animate-landing-rise'>
            ...
            <p className="mt-5 max-w-lg text-base text-slate-600 md:text-lg [font-family:'Nunito Sans',ui-sans-serif,system-ui]">
              Controle caixa, estoque, agenda, clientes e serviços em um painel
              simples. Menos retrabalho no balcão, mais previsibilidade no
              faturamento e atendimento mais rápido.
            </p>
            ...
            <div className='mt-8 flex flex-wrap gap-3'>
              <Link to='/register'>
                <Button
                  size='lg'
                  className='rounded-full bg-[#ffbf66] px-8 text-base text-slate-900 hover:bg-[#ffb64e]'
                >
                  Testar grátis
            ...
            <div className='mt-8 grid max-w-xl gap-3 sm:grid-cols-3'>
              {quickFacts.map((fact) => (
                <Card
                  key={fact.label}
                  className='rounded-2xl border-[#efe2db] bg-white/90 shadow-none'
                >
                  <CardContent className='p-4 text-center'>
                    <p className="text-2xl font-semibold text-slate-900 [font-family:'Sora',ui-sans-serif,system-ui]">
                      {fact.value}
                    </p>
          ...
          <div className='relative mx-auto h-[420px] w-full max-w-[530px] overflow-hidden rounded-[32px] border border-[#f2e5de] bg-[radial-gradient(circle_at_16%_12%,#fff7ef_0%,#fffcf8_38%,#fffcf8_100%)] p-6'>
            ...
            <div className='absolute left-6 bottom-16 -rotate-6'>
              <div className='animate-landing-chip landing-chip-delay-1 rounded-2xl border border-[#f4e5dd] bg-white px-4 py-3 shadow-[0_16px_30px_-26px_rgba(26,24,20,0.9)]'>
                ...
                <p className='text-xs text-[#ba7a2f]'>
                  Venda + serviço no caixa
                </p>
              </div>
            </div>
        ...
        <section id='recursos' className='border-t border-[#f1e6df] pt-12'>
          ...
          <div className='grid gap-4 sm:grid-cols-2 lg:grid-cols-4'>
            {categories.map((item) => (
              <Card
                key={item.title}
                className='rounded-2xl border-[#ede0d8] bg-white shadow-none transition hover:-translate-y-1 hover:border-[#e3c8af]'
              >
        ...
        <section id='planos' className='py-12'>
          <div className='mb-6 flex flex-wrap items-end justify-between gap-4'>
            <div>
              <h2 className="text-3xl font-semibold text-slate-900 [font-family:'Sora',ui-sans-serif,system-ui]">
                Planos para escalar com segurança
              </h2>
              <p className='mt-2 text-sm text-slate-600 md:text-base'>
                Escolha o plano ideal para o momento da sua operação e evolua
                sem trocar de sistema.
              </p>
            </div>
            <Badge className='rounded-full border border-[#ffe2b7] bg-[#fff4df] text-[#9d6220]'>
              14 dias grátis
            </Badge>
          </div>
          ...
          <div className='grid gap-5 md:grid-cols-3'>
            {topPlans.map((product) => (
              <Card
                key={product.name}
                className='rounded-2xl border-[#eaded7] bg-white shadow-none'
              >
                <CardContent className='p-5'>
                  <Badge className='mb-4 rounded-full bg-[#ffeecf] text-[#97601f]'>
                    {product.badge}
                  </Badge>
                  ...
                  <div className='mt-5 flex items-center justify-between'>
                    ...
                    <Button className='rounded-full bg-[#273140] text-white hover:bg-[#1f2732]'>
                      Assinar
                    </Button>
                  </div>
                </CardContent>
        ...
        <section
          id='resultados'
          className='rounded-3xl border border-[#eddfd7] bg-[#fff8f1] p-6'
        >
          <div className='mb-5'>
            <p className='text-sm font-medium text-[#b47a39]'>
              Antes do próximo fechamento
            </p>
            <h2 className="text-2xl font-semibold text-slate-900 [font-family:'Sora',ui-sans-serif,system-ui]">
              Sua operação mais organizada e previsível a partir de hoje
            </h2>
            <p className='mt-2 max-w-3xl text-sm text-slate-600 md:text-base'>
              Menos retrabalho no atendimento, mais controle no caixa e
              visibilidade total da rotina do seu pet shop.
            </p>
          </div>
          ...
          <div className='grid gap-4 md:grid-cols-3'>
            {trustItems.map((item) => (
              <div
                key={item.title}
                className='rounded-2xl border border-[#efdccf] bg-white p-4'
              >
        ...
        <footer id='contato' className='pt-12'>
          ...
          <div className='flex flex-wrap items-center justify-between gap-4 pt-6 text-sm text-slate-600'>
            <p>
              © {new Date().getFullYear()} FourPet Pro. Todos os direitos
              reservados.
            </p>
